<?php /* Smarty version Smarty-3.1.14, created on 2016-03-20 15:27:19
         compiled from "/home/it/web/wa-system/page/templates/PageEdit.html" */ ?>
<?php /*%%SmartyHeaderCode:64888447656ee972733d2c7-18191104%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'da9ee6ecfe6113b535b6f92f9d5aa61d17bee0a3' => 
    array (
      0 => '/home/it/web/wa-system/page/templates/PageEdit.html',
      1 => 1452519810,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '64888447656ee972733d2c7-18191104',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56ee97276b03b2_53396355',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56ee97276b03b2_53396355')) {function content_56ee97276b03b2_53396355($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_wa_datetime')) include '/home/it/web/wa-system/vendors/smarty-plugins/modifier.wa_datetime.php';
...
<?php }?>", function () {
                    ...
                    $("#wa-editor-help").on('click', "div.fields a.inline-link", function () {
                        ...
                        $('#wa-page-content').waEditor('insert.html', el.text());
                        return false;
                    });
                </script>
            </div>
...
";
            <?php }else{ ?>
            document.title = "New page — <?php echo $_smarty_tpl->tpl_vars['wa']->value->appName();?>
";
            <?php }?>
        <?php }?>
