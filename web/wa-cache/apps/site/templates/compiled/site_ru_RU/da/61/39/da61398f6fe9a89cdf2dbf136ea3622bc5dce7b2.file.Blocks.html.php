<?php /* Smarty version Smarty-3.1.14, created on 2016-03-18 17:49:51
         compiled from "/home/it/web/wa-apps/site/templates/actions/blocks/Blocks.html" */ ?>
<?php /*%%SmartyHeaderCode:142942409556ec158f184347-25754004%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'da61398f6fe9a89cdf2dbf136ea3622bc5dce7b2' => 
    array (
      0 => '/home/it/web/wa-apps/site/templates/actions/blocks/Blocks.html',
      1 => 1398338872,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '142942409556ec158f184347-25754004',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56ec158f37ffb7_19938762',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56ec158f37ffb7_19938762')) {function content_56ec158f37ffb7_19938762($_smarty_tpl) {?><script src="<?php echo $_smarty_tpl->tpl_vars['wa_url']->value;?>
...
<?php }?>" width="16" height="16"><?php }else{ ?><i class="icon16 zone"></i><?php }?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['b']->value['id'], ENT_QUOTES, 'UTF-8', true);?>

                        <span class="hint"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['b']->value['description'], ENT_QUOTES, 'UTF-8', true);?>
</span>
                    </a>
                </li>
                <?php } ?>
...
<div class="content left200px">
    ...
    <form id="site-form" method="post" action="?module=blocks&action=save<?php if ($_smarty_tpl->tpl_vars['block']->value&&!isset($_smarty_tpl->tpl_vars['block']->value['app'])){?>&id=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['id'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?>">
        <div class="block s-grey-toolbar">
            ...
            <ul class="menu-h">
                ...
                <li><a id="s-block-delete" href="#"><?php if (isset($_smarty_tpl->tpl_vars['block']->value['original'])){?><i class="icon16 broom"></i>Восстановить из оргинала<?php }else{ ?><i class="icon16 delete"></i>Удалить<?php }?></a></li>
                <?php }?>
            </ul>
            </div>
            <h4><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['id'], ENT_QUOTES, 'UTF-8', true);?>
</h4>
            <span class="hint">Встроить на страницу или в шаблон:<br>
                <strong class="s-block-code">&#123;$wa-&gt;block("<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['id'], ENT_QUOTES, 'UTF-8', true);?>
")&#125;</strong>
            </span>
            <?php }?>
            <div id="s-block-settings" style="<?php if ($_smarty_tpl->tpl_vars['block']->value){?>display: none;<?php }?>">
                <div class="fields form">
                    <div class="field">
                        ...
                        <div class="value">
                            <input name="info[id]" type="text" class="bold large" value="<?php if ($_smarty_tpl->tpl_vars['block']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['id'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" />
                        </div>
                    </div>
                    <div class="field">
                        ...
                        <div class="value">
                            <textarea name="info[description]"><?php if ($_smarty_tpl->tpl_vars['block']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['description'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?></textarea>
                        </div>
                    </div>
                </div>
        ...
        <div class="s-editor-core-wrapper">
            <div class="ace">
                <textarea id="content" name="info[content]" class="s-entire-core" style="width:99%"><?php if ($_smarty_tpl->tpl_vars['block']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['content'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?></textarea>
            </div>
        </div>            
    </form>    
    ...
    <div class="dialog-window">
        <div class="dialog-content">
            <div class="dialog-content-indent">
                ...
                <div id="s-block-original" style="width: 100%; height: 220px;"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['original'], ENT_QUOTES, 'UTF-8', true);?>
</div>
            </div>
        </div>
...
')) {
        $.post("?module=blocks&action=delete", { id: "<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['id'], ENT_QUOTES, 'UTF-8', true);?>
"}, function (response) {
            if (response.status == 'ok') {
                <?php if (!isset($_smarty_tpl->tpl_vars['block']->value['original'])){?>
                ...
                <?php }?>
                $("div.s-editor").empty();
                $('#ul-blocks li[data-block-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['id'], ENT_QUOTES, 'UTF-8', true);?>
"]').remove();
                <?php if (!isset($_smarty_tpl->tpl_vars['block']->value['original'])){?>
                    $.wa.setHash(hash);
                <?php }else{ ?>
