<?php /* Smarty version Smarty-3.1.14, created on 2016-03-20 15:28:10
         compiled from "/home/it/web/wa-apps/shop/templates/layouts/Backend.html" */ ?>
<?php /*%%SmartyHeaderCode:113104447256ee975ae00ca8-85330870%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c46737ff8d095fc79549307886a8da14795311d6' => 
    array (
      0 => '/home/it/web/wa-apps/shop/templates/layouts/Backend.html',
      1 => 1438073177,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '113104447256ee975ae00ca8-85330870',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56ee975b15bde9_09174450',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56ee975b15bde9_09174450')) {function content_56ee975b15bde9_09174450($_smarty_tpl) {?><?php if (!is_callable('smarty_block_wa_js')) include '/home/it/web/wa-system/vendors/smarty-plugins/block.wa_js.php';
?><!DOCTYPE html><html>
<head>
...
<div id="wa"<?php if (isset($_smarty_tpl->tpl_vars['no_level2']->value)){?> class="s-no-level2"<?php }?>>
    ...
    <div id="wa-app">
        ...
        <div id="mainmenu">
            <ul class="tabs">
                <?php $_smarty_tpl->tpl_vars['rightmost_li_margin'] = new Smarty_variable(' style="margin-right: 30px;"', null, 0);?>
                <?php if ($_smarty_tpl->tpl_vars['wa']->value->userRights('settings')){?>
                    <li class="small float-right<?php if ($_smarty_tpl->tpl_vars['page']->value=='plugins'){?> selected<?php }else{ ?> no-tab<?php }?>"<?php echo $_smarty_tpl->tpl_vars['rightmost_li_margin']->value;?>
>
                    ...
                    <?php $_smarty_tpl->tpl_vars['rightmost_li_margin'] = new Smarty_variable('', null, 0);?>
                <?php }?>
...
<?php } ?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['tutorial_visible']->value){?>
                    <li class="no-tab s-tutorial-tab" id="mainmenu-tutorial-tab">
                        <a href="<?php echo $_smarty_tpl->tpl_vars['wa_app_url']->value;?>
?module=tutorial" title="Помощник настройки магазина">
                            <div class="s-tutorial-progressbar" id="s-tutorial-progressbar">
                                <div class="s-tutorial-progressbar-outer">
                                    ...
                                    <span id="s-tutorial-progressbar-content"></span>
                                </div>
                            </div>
                        </a>
                        <script type="text/javascript">$(function() { "use strict";
                            $('#s-tutorial-progressbar .s-tutorial-progressbar-inner').css('width', "<?php echo $_smarty_tpl->tpl_vars['tutorial_progress']->value;?>
%");
                            $('#s-tutorial-progressbar-content').text("<?php echo $_smarty_tpl->tpl_vars['tutorial_progress']->value;?>
%");
                        });</script>
                    </li>
                <?php }?>
...
<?php }?></sup>
                ...
                <?php }?>
                <?php if ($_smarty_tpl->tpl_vars['wa']->value->userRights('customers')){?>
...
" target="_blank">Открыть витрину</a>
                </li>
            </ul>
                ...
                <div class="block bordered-bottom">
                    ...
                    <?php }elseif($_smarty_tpl->tpl_vars['page']->value=='customers'){?>
                        ...
                        <ul class="menu-h with-icons">
                            <div class="s-search-form">
                                <i class="icon16 ss search-bw"></i>
                                <input type="search" placeholder="Поиск покупателей" id="s-customers-search">
                            </div>
                        </ul>
                    ...
                    <?php }elseif($_smarty_tpl->tpl_vars['page']->value=='reports'){?>
                            ...
                            <ul class="menu-h dropdown s-reports-timeframe" style="float: right;">
                                ...
                                <li class="s-reports-timeframe-dropdown">
                                    ...
                                    <ul class="menu-v">
                                        ...
                                        <li data-timeframe="90" data-groupby="days" data-default-choice="1"><a href="javascript:void(0)" class="nowrap"><?php echo _w('Last %d day','Last %d days',90);?>
</a></li>
                                        <li data-timeframe="365" data-groupby="months"><a href="javascript:void(0)" class="nowrap"><?php echo _w('Last %d day','Last %d days',365);?>
</a></li>
                                        <li data-timeframe="all" data-groupby="months"><a href="javascript:void(0)" class="nowrap">Все время</a></li>
                                        <li data-timeframe="custom"><a href="javascript:void(0)" class="nowrap">Выбрать даты…</a></li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <ul class="menu-h s-reports">
                            <?php if ($_smarty_tpl->tpl_vars['wa']->value->shop->config('reports_simple')){?>
                                <li>
                                    <a href="#/summary/">Продажи</a>
                                </li>
                            <?php }else{ ?>
                                <li>
