<?php /* Smarty version Smarty-3.1.14, created on 2016-03-20 15:28:10
         compiled from "/home/it/web/wa-apps/shop/templates/actions/backend/BackendOrders.html" */ ?>
<?php /*%%SmartyHeaderCode:49172972056ee975abc3363-49239366%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7442b2c6358868a6ce7371c4034d169cedfb7c9f' => 
    array (
      0 => '/home/it/web/wa-apps/shop/templates/actions/backend/BackendOrders.html',
      1 => 1438073176,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '49172972056ee975abc3363-49239366',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56ee975adc3fa5_55478604',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56ee975adc3fa5_55478604')) {function content_56ee975adc3fa5_55478604($_smarty_tpl) {?><?php if (!is_callable('smarty_block_wa_js')) include '/home/it/web/wa-system/vendors/smarty-plugins/block.wa_js.php';
...
"></i><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['state']->value->getName(), ENT_QUOTES, 'UTF-8', true);?>
    ...
    <?php if (!empty($_smarty_tpl->tpl_vars['storefronts']->value)){?>
    <div class="block">
...
"><?php if (substr($_smarty_tpl->tpl_vars['url']->value,-1)=='/'){?><?php echo str_replace('www.','',substr($_smarty_tpl->tpl_vars['url']->value,0,-1));?>
<?php }else{ ?><?php echo str_replace('www.','',$_smarty_tpl->tpl_vars['url']->value);?>
<?php }?></a>
                </li>
            <?php } ?>
            <li data-storefront="NULL">
                <span class="count"><?php echo $_smarty_tpl->tpl_vars['backend_count']->value;?>
</span>
                <a href="#/orders/storefront=NULL">Бекенд</a>
            </li>
        </ul>
    </div>
    <?php }?>
